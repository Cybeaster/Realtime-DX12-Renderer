...
vector<wstring> OApplication::GetShaderFolders() const
{
	return ShaderFolders;
}

wstring OApplication::GetRootShaderFolder() const
{
	return RootDirPath.GetWPath() + L"Shaders/";
}

wstring OApplication::GetRaytracingShaderFolder() const
{
	return RootDirPath.GetWPath() + L"Shaders/Raytracing/";
}